    ...
    return (
      <div>
        <div className="rounded-2xl border border-[#a9cfc3] bg-[#eaf5f1] p-5">
          ...
          >
            {loading === "credit" ? "Ouverture du rapport…" : "Utiliser 1 crédit et ouvrir le rapport"}
          </button>
        </div>
        ...
        >
          Débloquer uniquement ce rapport — 8,90 €
        </button>
    ...
    <div>
      <div className="space-y-3">
        {!subscriptionActive && (
          ...
          >
            <span className="absolute right-3 top-3 rounded-full bg-[#0c5b50] px-3 py-1 text-[10px] font-semibold uppercase tracking-[0.08em] text-white">Recommandé</span>
            <p className="pr-24 text-xs font-semibold uppercase tracking-[0.08em] text-[#5d8179]">DevisVéto Plus</p>
            <div className="mt-2 flex items-baseline gap-2">
              <span className="font-serif text-4xl font-semibold tracking-[-0.025em] text-[#123f38]">6,90 €</span>
              <span className="text-xs font-semibold text-[#78908a]">par mois</span>
            </div>
            <p className="mt-3 text-sm font-semibold text-[#315f57]">Ce rapport et son PDF sont inclus immédiatement.</p>
            <ul className="mt-4 space-y-2 text-xs font-semibold leading-5 text-[#526f68]">
              ...
              <li>✓ Fiches, suivi du poids et rappels</li>
              <li>✓ Résiliable à tout moment</li>
            </ul>
            <span className="mt-5 flex w-full justify-center rounded-full bg-[#0c5b50] px-4 py-3 text-sm font-semibold text-white">
              {loading === "monthly" ? "Ouverture de Stripe…" : "Débloquer avec DevisVéto Plus"}
            </span>
          </button>
        )}
        ...
        >
          <p className="text-xs font-semibold uppercase tracking-[0.08em] text-[#78908a]">Rapport unique</p>
          <div className="mt-2 flex items-baseline gap-2">
          ...
          <p className="mt-3 text-sm leading-6 text-[#647d77]">Le rapport complet et son PDF, sans abonnement ni renouvellement.</p>
          <span className="mt-4 flex w-full justify-center rounded-full border border-[#bfd5ce] px-4 py-3 text-sm font-semibold text-[#315f57]">
            {loading === "single" ? "Ouverture de Stripe…" : "Débloquer uniquement ce rapport"}
          </span>
        </button>
      </div>
